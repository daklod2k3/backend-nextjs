CREATE DATABASE  IF NOT EXISTS `it-shop` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `it-shop`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: localhost    Database: it-shop
-- ------------------------------------------------------
...
INSERT INTO `banner` VALUES (1,'huawei-band-9-sliding.webp','https://cellphones.com.vn/vong-deo-tay-thong-minh-huawei-band-9.html'),(2,'samsung-galaxy-m34-5g-home-page.webp',''),(3,'iphone-15-17390-sliding.webp',''),(4,'sony-xperia-10-sliding.webp','');
...
INSERT INTO `category` VALUES (1,'Laptop'),(2,'Iphone'),(3,'Android'),(4,'Phụ kiện');
...
INSERT INTO `customer` VALUES (2,'Loc',NULL,NULL,NULL,3),(3,'Loc',NULL,NULL,NULL,4),(4,'Loc',NULL,NULL,NULL,6),(5,'Loc',NULL,'013414',NULL,7),(6,'Loc',NULL,'013414',NULL,8),(7,'Loc',NULL,'013414',NULL,9);
...
CREATE TABLE `invoice` (
  ...
  KEY `fk_invoice_employee_1` (`employee_id`),
  KEY `fk_invoice_invoice_status` (`status_id`),
  KEY `fk_invoice_user` (`user_id`),
  CONSTRAINT `fk_invoice_employee_1` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`employee_id`),
  CONSTRAINT `fk_invoice_invoice_status` FOREIGN KEY (`status_id`) REFERENCES `invoice_status` (`status_id`),
...
INSERT INTO `invoice` VALUES (12,NULL,3,1,NULL),(14,NULL,3,1,NULL),(15,NULL,3,1,NULL),(16,NULL,3,1,NULL),(17,NULL,3,1,NULL),(18,NULL,3,1,NULL),(19,NULL,3,1,NULL),(20,NULL,3,1,NULL),(21,NULL,3,1,NULL),(22,NULL,3,1,NULL),(23,NULL,3,1,NULL),(24,NULL,3,1,NULL),(25,NULL,3,1,NULL),(26,NULL,3,1,'2024-05-12'),(27,NULL,3,1,'2024-05-12'),(28,NULL,3,1,'2024-05-12'),(29,NULL,3,1,'2024-05-12'),(30,NULL,3,1,'2024-05-12'),(36,NULL,3,1,'2024-05-12'),(38,NULL,3,1,'2024-05-12'),(39,NULL,3,1,'2024-05-12'),(40,NULL,3,1,'2024-05-12'),(41,NULL,3,1,'2024-05-12'),(42,NULL,3,1,'2024-05-12'),(43,NULL,3,1,'2024-05-12'),(44,NULL,3,1,'2024-05-12');
...
CREATE TABLE `invoice_detail` (
  ...
  PRIMARY KEY (`product_id`,`user_id`,`invoice_id`),
  KEY `fk_invoice_detail_invoice` (`invoice_id`),
  KEY `fk_invoice_detail_user` (`user_id`),
  KEY `ix_autoincrement_INVOICE_DETAIL` (`id`),
  ...
  CONSTRAINT `fk_invoice_detail_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
...
INSERT INTO `invoice_status` VALUES (1,'Đợi xác nhận'),(2,'Đang giao hàng'),(3,'Đã nhận hàng'),(4,'Giỏ hàng');
...
CREATE TABLE `role+function` (
  ...
  KEY `fk_role_function_function` (`function_id`),
  CONSTRAINT `fk_role_function_function` FOREIGN KEY (`function_id`) REFERENCES `function` (`function_id`),
  CONSTRAINT `fk_role_function_role` FOREIGN KEY (`role_id`) REFERENCES `role` (`role_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `role+function`
--

LOCK TABLES `role+function` WRITE;
/*!40000 ALTER TABLE `role+function` DISABLE KEYS */;
/*!40000 ALTER TABLE `role+function` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `user` VALUES (3,'abc','$2b$10$dBfnQN3mvjtUJxVZ8VEscu6yCf1tdr0zyPm9rZN.8MO7O7YyAnf4e',NULL,_binary '',3),(4,'ad','$2b$10$C0J9n0r3RueyQBVKmKmHdenItJS41PRQETNP6r7c1.JtfPbOg5ZfO',NULL,_binary '',3),(5,'admin','$2b$10$C0J9n0r3RueyQBVKmKmHdenItJS41PRQETNP6r7c1.JtfPbOg5ZfO',NULL,_binary '',1),(6,'login1','$2b$10$1s04HSj8wgk6h3nL5yluuOZSvmx98xvd.dNtv6V/pL/hTtBkbqjVS',NULL,_binary '',3),(7,'login2','$2b$10$6zduEMfu.EghDsFKjJw8Dug.2bogRx9jC7ku70ujR5maPVffSd7LK',NULL,_binary '',3),(8,'login4','$2b$10$GdziQYalAy40yF5n0MakvesCTpx4rirJrn0fDx9Gd7CHuUo3SAGkS',NULL,_binary '',3),(9,'login3','$2b$10$TYfYOeGl9JIZiWA0Fv.zHezPyQRrcRMNfWqS0m.SmdQLEBCLWcRY.',NULL,_binary '',3);
...
INSERT INTO `vendor` VALUES ('Asus',1),('Apple',2),('Gigabyte',3),('Samsung',4),('Xiaomi',5),('MSI',6),('Ugreen',7),('Logitech',8);
...
-- Dump completed on 2024-05-13  8:57:49
